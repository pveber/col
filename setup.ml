...
(* OASIS_START *)
(* DO NOT EDIT (digest: bbeea8a7d9ca389b5522abd241df2961) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/pveber/col";
          synopsis =
            "Syntax extension for easier manipulation of flat records";
          description =
            Some
            ...
            [
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/pveber/col.git";
                      src_repo_browser = Some "https://github.com/pveber/col";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Col"; "Run_col_lexer"; "Run_col_main"];
               ...
               Library
                 ({
                      ...
                      },
                   {
                      lib_modules = ["Pa_col"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "col";
                      lib_findlib_name = Some "syntax";
                      lib_findlib_containers = [];
                      })
            ];
          plugins =
            [(`Extra, "StdFiles", Some "0.2"); (`Extra, "META", Some "0.2")];
